  ...
  return (
    <Modal onClose={() => setDetailOrder({})}>
      <div>
        ...
        <h2 className={styles.modal__title}>Data Recipient</h2>
        <div className={styles.modal__data}>
          <div className={styles.modal__data__item}>
            <h4>Name</h4>
                  ...
                  <Fragment key={`${item.id}-${item.size}`}>
                    <div className={styles.modal__product__item}>
                      ...
                      <div className={styles.modal__product__item__info}>
                        <h4
                          className={
                            styles.modal__product__item__info__title
                          }
                        >
                        ...
                        <div
                          className={
                            styles.modal__product__item__info__data
                          }
                        >
                          <label
                            className={
                              styles.modal__product__item__info__data__size
                            }
                          >
                            Size {item.size}
                          </label>
                          <label
                            className={
                              styles.modal__product__item__info__data__qty
                            }
                          >
                            Quantity {item.qty}
                          </label>
                    ...
                    <hr className={styles.modal__product__divider} />
                  </Fragment>
                )
              )}
            </div>
